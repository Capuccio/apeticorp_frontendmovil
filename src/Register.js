...
const Register = props => {
  ...
  handleRegister = async () => {
    if (
      !Register.form.name.trim() ||
      !Register.form.lastname.trim() ||
      !Register.form.email.trim() ||
      !Register.form.mobile.trim() ||
      !Register.form.password.trim()
    ) {
      Alert.alert("Rellenar todos los capos");
    } else {
